...
public class VisitSummaryPage extends BasePage {
	...
	By vstsumpatientSectionOccupation = By.xpath("//h6[contains(@data-test-id,'etPatient') and contains(text(),'Occupation')]");
	By vstsumpatientSectionNationalID = By.xpath("//h6[contains(@data-test-id,'etPatient') and contains(text(),'National ID')]");
	...
	By vstsumPastVstHistoryTab = By.xpath("//div[@class='mat-ripple mat-tab-label mat-focus-indicator ng-star-inserted']");
